...
class rqlite:
    ...
    def init(self):
        ...
        self.execute(["CREATE TABLE vhosts (id INTEGER NOT NULL PRIMARY KEY, domain TEXT NOT NULL, subdomain TEXT NOT NULL, type TEXT NOT NULL, value TEXT NOT NULL, updated INTEGER NULL, FOREIGN KEY(domain) REFERENCES domains(domain) ON DELETE CASCADE)"])
