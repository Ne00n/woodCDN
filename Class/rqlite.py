...
class rqlite:
    ...
    def init(self):
        self.execute(["CREATE TABLE pops (name TEXT NOT NULL PRIMARY KEY, location TEXT NOT NULL, latitude DECIMAL(10,7) NOT NULL, longitude DECIMAL(10,7) NOT NULL, v4 TEXT NOT NULL, lastrun INTEGER NULL)"])
